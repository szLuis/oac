...
<script>
 $(document).ready(function() {
       ...
       $("#filtrarbydate").submit(function () {
//		if ($(this).val() > 5){};
                    $.ajax({
                            url: "proceso/ajax.php",
...
<body>
    <div class="container">
        ...
        <br>     
            <form class="form-horizontal" id="filtrarbydate" role="form" name="filtrarbydate" method="post" action="registrar_proceso.php">
<div class="row">
...
<div  class="row">
    <div class="col-md-offset-4 col-md-4 col-md-offset-4">
        <input type="submit" class="btn btn-primary btn-lg btn-block"  name="Submit" value="Enviar"/>   
