...
//        '<br><br><br><h1 style="text-align:center;">Recepción de ' . $proceso . '</h1><br><br><br><br><br><br><br><br>'
        $html.= '<p style="text-align:justify; margin-bottom: -2px; "><b>Tipo:</b> ' . trim($rs['tipo_atencion']) .'</p><br>';
         $html.= '<p style="text-align:justify; margin-bottom: -2px;"><b>Tarea realizada:</b> ' . trim($rs['narracion_hechos']) .'</p><br>';
        $html.= '<p style="text-align:justify; margin-bottom: -2px;"><b>Observaciones:</b> ' . trim($rs['observaciones']) .'</p><br>';
