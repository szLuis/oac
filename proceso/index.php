    ...
    <div class="col-md-2">
        <div data-spy="affix" style="margin-top: 50px;" data-offset-top="60" data-offset-bottom="200">
            <div class="list-group">
                <a href="../index.php?opcion=denuncia" class="list-group-item active">
                  <span class="glyphicon glyphicon-floppy-disk" ></span> Registrar atención
                </a>
                <a href="../index_atencion.php" class="list-group-item"><span style="color: #428bca;" class="glyphicon glyphicon-search" ></span><span style="color: #428bca;"> Atenciones</span> </a>
                ...
                <a href="../resumen_por_fecha.php" class="list-group-item"><span class="glyphicon glyphicon-filter" ></span> Filtrar por fecha</a>
                <a href="../atenciones_por_fecha.php" class="list-group-item"><span class="glyphicon glyphicon-filter" ></span> Atenciones por fecha</a>
            </div>
        </div>
        ...
        <?php 
            ...
            <fieldset><legend><span style="color:<?php echo $codigo; ?>">Datos de la Atención</span> </legend>
                    ...
                    <div class="form-group">    
                        ...
                        <div class="col-md-8">
                            <textarea name="txtnarracionhechos" class="form-control" rows="3" id="txtnarracionhechos" 
                    ...
                    <div class="form-group">    
                        ...
                        <div class="col-md-8">
                            <textarea name="txtobservaciones" class="form-control" rows="3" id="txtobservaciones" 
                                      data-toggle="tooltip" data-placement="right" <?php if (isset($readonly)) echo $readonly; ?>
